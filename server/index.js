...
app.get('/api/connections/mine', authMiddleware, async (req, res) => {
  try {
    const cols = `c.id, c.user_profile_id, c.mentor_id, c.user_id, c.status, c.created_at, c.is_collab,
      ...
      up.subfield as mentee_subfield, up.level as mentee_level, up.year as mentee_year,
      up.year_set_date as mentee_year_set_date, up.tags as mentee_tags, up.state as mentee_state,
      up.institution as mentee_institution, up.is_img as mentee_is_img, up.bio as mentee_bio,
      up.specialties as mentee_specialties, up.avatar_grad as mentee_avatar_grad,
