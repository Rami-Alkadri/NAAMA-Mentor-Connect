...
- The user creates a **Scheduled Deployment** via the Publishing UI (Publishing → Scheduled) pointing at that command, with a schedule + timezone (e.g. `America/Chicago`).
